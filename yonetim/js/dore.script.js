  ...
  function init() {
    ...
    if (typeof Chart !== "undefined") {
      ...
      if (document.getElementById("visitChart")) {
        ...
        // Haftalık Ziyaretçi Verilerini çeker
        $.post("modules/prodata.php", function (data) {

          let cleardata = data.split("prodata=Ziyaretci")
          let cleardata2 = cleardata[1].split("prodata=KisaltilanLink")
          let visitsdatas = cleardata2[0]

          // Haftalık Ziyaretçi Verilerini parçala
          let vData = visitsdatas.split("&")

          // Verileri Değişkenlere Ata
          let bugun = vData[0].split("=")
          let bugunG = bugun[0]
          let bugunS = bugun[1]

          let dun = vData[1].split("=")
          let dunG = dun[0]
          let dunS = dun[1]

          let oncekigun = vData[2].split("=")
          let oncekigunG = oncekigun[0]
          let oncekigunS = oncekigun[1]

          let ucgunonce = vData[3].split("=")
          let ucgunonceG = ucgunonce[0]
          let ucgunonceS = ucgunonce[1]

          let dortgunonce = vData[4].split("=")
          let dortgunonceG = dortgunonce[0]
          let dortgunonceS = dortgunonce[1]

          let besgunonce = vData[5].split("=")
          let besgunonceG = besgunonce[0]
          let besgunonceS = besgunonce[1]

          let altigunonce = vData[6].split("=")
          let altigunonceG = altigunonce[0]
          let altigunonceS = altigunonce[1]

          //console.log(altigunonceG)


          // Min, Max Hesaplayıcı

          vDataSayilar = [altigunonceS, besgunonceS, dortgunonceS, ucgunonceS, oncekigunS, dunS, bugunS];

          //console.log(vDataSayilar[6])
          ...
          var myChart = new Chart(visitChart, {
            ...
            data: {
              labels: [altigunonceG, besgunonceG, dortgunonceG, ucgunonceG, oncekigunG, dunG, bugunG],
              datasets: [
                {

                  label: "",
                  data: [altigunonceS, besgunonceS, dortgunonceS, ucgunonceS, oncekigunS, dunS, bugunS],
                  borderColor: themeColor1,
      ...
      if (document.getElementById("conversionChart")) {
        ...
        $.post("modules/prodata.php", function (data) {
          ...
          let cleardata = data.split("prodata=KisaltilanLink")
          let visitsdatas = cleardata[1]
